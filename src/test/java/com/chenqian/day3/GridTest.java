...
public class GridTest {
    ...
    public void gridTest() throws MalformedURLException, InterruptedException {
     ...
     //   WebDriver driver=new RemoteWebDriver(new URL("http://192.168.1.105:4444/wd/hub"),fireFoxDC);
      DesiredCapabilities chromeDC=DesiredCapabilities.chrome();
        //指定机器的ip和hub端口，wd/hub必须要写
        WebDriver driver=new RemoteWebDriver(new URL("http://192.168.1.105:4444/wd/hub"),chromeDC);
